...
::ZQ05rAF9IAHYFVzEqQISCTh/YT2xDUfa
::eg0/rx1wNQPfEVWB+kM9LVsJDCajH0CXP4YtxIg=
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFDFbQgWWPWWGIrAP4/z0/9azrUkSaNMqfc/S1KeaIewS+AX0dIQslnJVi98JABhXQgiIYRw1ui5MuSSKNcuVtA71RVqA51hwC2BmiCPAgzgyYt9tiYMN1iO770T7nqEVwkTMV7oaEG6h461rM9wQwSi1fHXqu5B+Z8/dWpGkED/GN2AYi3XRmM1vhoZN
::YB416Ek+ZG8=
::
::
...
mysqldump --skip-opt --skip-triggers --default-character-set=latin1 --extended-insert -u root elco_reports > "C:\Backups\elco_reports.sql"
cd c:\Backups\
