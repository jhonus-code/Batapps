...
::
::YAwzoRdxOk+EWAjk
::fBw5plQjdCyDJGyX8VAjFDFbQgWWPWWGIroL5uT07u6Unh9KA7FnL8HS2bvu
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFDFbQgWWPWWGIrAP4/z0/9a0q14JUe9/Wo7Y0aGeHMIS/nnKerc9131bloUJFB44
::YB416Ek+ZW8=
::
::
...
:invalid
echo LLevamos 60 minutos intentando y la tabla buffer aun tiene lineas pasamos a reiniciar replica y Hamachi.
...
:salida
echo OK:Buffer vacio cuando se analizo cerramos tarea replica migrada.>> Logs/Log_no_apagado_%dia%-%mes%-%anio%_%HORA%.%MINUTOS%.%SEGUNDOS%.log
exit
